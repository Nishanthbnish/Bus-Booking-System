...
<div class="row">
      ...
      <div class="cell" data-title="Scheduled Arrival">
       <%=rs.getString(4) %>
        ...
        <div class="cell" data-title="Distination">
       <%=rs.getString(5) %>
      </div>
      <div class="cell" data-title="Scheduled distination arrival">
       <%=rs.getString(6) %>
      </div>
      <div class="cell" data-title="Departure date">
       <%=rs.getString(7) %>
      </div>
      <div class="cell" data-title="Route Id">
       <%=rs.getString(8) %>
      </div>
